...
public class BossAttackParameterScript : MonoBehaviour
{
    ...
    private System.Collections.IEnumerator ShootLoop()
    {
        ...
        while (playerInRange && !GetComponent<BossHealthScript>().isFriend)
        {
            ShootAtPlayer();
    ...
    private void Update()
    {
        if (GetComponent<BossHealthScript>().isFriend)
            return;
    }
